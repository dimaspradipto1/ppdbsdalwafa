...
class UpdateKebutuhanKhususRequest extends FormRequest
{
    /**
    ...
    {
        $kebutuhan = $this->route('kebutuhanKhusus') ?? $this->route('kebutuhan_khusus') ?? $this->route('kebutuhan');
        $idKebutuhan = is_object($kebutuhan) ? $kebutuhan->id_kebutuhan : $kebutuhan;
        ...
        return [
            'kode' => [
                ...
                'string',
                'max:50',
                Rule::unique('ref_kebutuhan_khusus', 'kode')->ignore($idKebutuhan, 'id_kebutuhan'),
            ],
