...
class UpdateJenisDokumenRequest extends FormRequest
{
    ...
    {
        $jenisDokumen = $this->route('persyaratan_dokumen') ?? $this->route('jenisDokumen') ?? $this->route('jenis_dokumen');
        $id = is_object($jenisDokumen) ? $jenisDokumen->id_jenis_dokumen : $jenisDokumen;
        ...
        return [
            'kode' => [
                ...
                'string',
                'max:50',
                Rule::unique('ref_jenis_dokumen', 'kode')->ignore($id, 'id_jenis_dokumen'),
            ],
