    ...
    <div class="col-lg-8">
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body pt-3">
          <h5 class="card-title">Form Tambah Gelombang Pendaftaran</h5>
          ...
          <form action="{{ route('gelombang.store') }}" method="POST">
                ...
                <select name="id_tahun_ajaran" id="id_tahun_ajaran" class="form-select @error('id_tahun_ajaran') is-invalid @enderror" required>
                  ...
                  @foreach($tahunAjaranList as $ta)
                    <option value="{{ $ta->id_tahun_ajaran }}" {{ old('id_tahun_ajaran', optional($activeTahunAjaran)->id_tahun_ajaran) == $ta->id_tahun_ajaran ? 'selected' : '' }}>
                      {{ $ta->tahun_ajaran }} {{ $ta->is_active ? '(Tahun Aktif Saat Ini)' : '' }}
                    </option>
                  @endforeach
                </select>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="nama_gelombang" id="nama_gelombang" class="form-control @error('nama_gelombang') is-invalid @enderror" value="{{ old('nama_gelombang') }}" placeholder="Contoh: Gelombang 1 (Indent), Gelombang 2 (Reguler)" required autofocus>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" name="kuota" id="kuota" min="0" class="form-control @error('kuota') is-invalid @enderror" value="{{ old('kuota') }}" placeholder="Kosongkan jika kuota tidak dibatasi">
            ...
            <div class="mb-4">
              ...
              <div class="input-group">
                ...
                <input type="text" name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan') }}" placeholder="Catatan atau informasi tambahan mengenai gelombang ini">
              </div>
              @error('keterangan')
                <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
            ...
            <div class="d-flex justify-content-end gap-2">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="bi bi-save me-1"></i> Simpan Gelombang
              </button>
            </div>
