      ...
      <div class="card">
        <div class="card-body pt-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="card-title p-0 m-0">Daftar Data Pekerjaan</h5>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100" id="pekerjaan-table">
              <thead>
                <tr>
                  <th style="width: 5%" class="text-center">No</th>
                  <th>Nama Pekerjaan / Profesi</th>
                  <th>Keterangan</th>
...
@push('scripts')
  ...
  <script>
    $(document).ready(function () {
      const table = $('#pekerjaan-table').DataTable({
        processing: true,
        serverSide: true,
        ...
        language: {
          ...
          zeroRecords: "Tidak ada data pekerjaan yang cocok",
      ...
      // SweetAlert2 Konfirmasi Hapus Pekerjaan
      $(document).on('click', '.btn-delete', function () {
        ...
        Swal.fire({
          ...
          text: `Apakah Anda yakin ingin menghapus data pekerjaan "${name}"?`,
          icon: 'warning',
