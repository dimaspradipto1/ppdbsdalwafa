...
@section('content')
<div class="pagetitle">
  <h1>Formulir Pendaftaran Calon Siswa</h1>
  <nav>
    <ol class="breadcrumb">
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <form action="{{ route('calon-siswa.store') }}" method="POST" id="form-calon-siswa">
        @csrf
            ...
            <div class="tab-content pt-2" id="pendaftaranTabContent">
              ...
              <div class="tab-pane fade show active" id="tab-identitas" role="tabpanel">
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror" value="{{ old('nama_lengkap') }}" placeholder="Masukkan nama lengkap siswa" required>
                  ...
                  <div class="col-md-3">
                    ...
                    <select name="id_agama" id="id_agama" class="form-select @error('id_agama') is-invalid @enderror">
                      ...
                      @foreach($daftarAgama as $ag)
                        <option value="{{ $ag->id_agama }}" {{ old('id_agama') == $ag->id_agama ? 'selected' : '' }}>{{ $ag->nama_agama }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="nik" id="nik" maxlength="16" class="form-control font-monospace @error('nik') is-invalid @enderror" value="{{ old('nik') }}" placeholder="16 digit NIK calon siswa">
                    @error('nik')<div class="invalid-feedback">{{ $message }}</div>@enderror
                  </div>

                  <div class="col-md-6">
                    <label for="nisn" class="form-label fw-semibold">NISN (Nomor Induk Siswa Nasional)</label>
                    <input type="text" name="nisn" id="nisn" maxlength="10" class="form-control font-monospace @error('nisn') is-invalid @enderror" value="{{ old('nisn') }}" placeholder="10 digit NISN jika sudah ada">
                  </div>

                  <div class="col-md-6">
                    <label for="tempat_lahir" class="form-label fw-semibold">Tempat Lahir <span class="text-danger">*</span></label>
                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir') }}" placeholder="Kota / Kabupaten kelahiran" required>
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" name="anak_ke" id="anak_ke" min="1" class="form-control" value="{{ old('anak_ke', 1) }}">
                  </div>

                  <div class="col-md-3">
                    <label for="jumlah_saudara_kandung" class="form-label fw-semibold">Jumlah Saudara Kandung</label>
                    <input type="number" name="jumlah_saudara_kandung" id="jumlah_saudara_kandung" min="0" class="form-control" value="{{ old('jumlah_saudara_kandung', 0) }}">
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="id_kebutuhan_khusus" id="id_kebutuhan_khusus" class="form-select">
                      ...
                      @foreach($daftarKebutuhanKhusus as $k)
                        <option value="{{ $k->id_kebutuhan }}" {{ old('id_kebutuhan_khusus') == $k->id_kebutuhan ? 'selected' : '' }}>
                          {{ $k->kode }} - {{ $k->nama }}
                        </option>
                      @endforeach
                    </select>
                    <div class="form-text">Pilih jika calon siswa memiliki kebutuhan khusus.</div>
                  </div>
              ...
              <div class="tab-pane fade" id="tab-alamat" role="tabpanel">
                ...
                <div class="row g-3">
                  <div class="col-md-8">
                    ...
                    <input type="text" name="alamat_jalan" id="alamat_jalan" class="form-control" value="{{ old('alamat_jalan') }}" placeholder="Jl. Merpati No. 12, Dusun Harapan">
                  </div>

                  <div class="col-md-2">
                    <label for="rt" class="form-label fw-semibold">RT</label>
                    <input type="text" name="rt" id="rt" maxlength="5" class="form-control" value="{{ old('rt') }}" placeholder="001">
                  </div>

                  <div class="col-md-2">
                    <label for="rw" class="form-label fw-semibold">RW</label>
                    <input type="text" name="rw" id="rw" maxlength="5" class="form-control" value="{{ old('rw') }}" placeholder="002">
                  </div>

                  <div class="col-md-4">
                    <label for="kelurahan" class="form-label fw-semibold">Kelurahan / Desa</label>
                    <input type="text" name="kelurahan" id="kelurahan" class="form-control" value="{{ old('kelurahan') }}" placeholder="Kelurahan">
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="kode_pos" id="kode_pos" maxlength="10" class="form-control font-monospace" value="{{ old('kode_pos') }}" placeholder="Contoh: 17530">
                  </div>

                  <div class="col-md-6">
                    <label for="kabupaten_kota" class="form-label fw-semibold">Kabupaten / Kota</label>
                    <input type="text" name="kabupaten_kota" id="kabupaten_kota" class="form-control" value="{{ old('kabupaten_kota') }}" placeholder="Kabupaten / Kota">
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <select name="jenis_tinggal" id="jenis_tinggal" class="form-select">
                      ...
                      <option value="Bersama Orangtua" {{ old('jenis_tinggal') == 'Bersama Orangtua' ? 'selected' : '' }}>Bersama Orangtua</option>
                  ...
                  <div class="col-md-4">
                    ...
                    <select name="alat_transportasi" id="alat_transportasi" class="form-select">
                      ...
                      <option value="Antar Jemput Sekolah" {{ old('alat_transportasi') == 'Antar Jemput Sekolah' ? 'selected' : '' }}>Antar Jemput Sekolah</option>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="telepon_rumah" id="telepon_rumah" class="form-control" value="{{ old('telepon_rumah') }}" placeholder="021-xxxxxxx">
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="nama@email.com">
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <select name="jarak_ke_sekolah" id="jarak_ke_sekolah" class="form-select">
                      ...
                      <option value="lebih dari 1 km" {{ old('jarak_ke_sekolah') == 'lebih dari 1 km' ? 'selected' : '' }}>Lebih dari 1 km</option>
                    </select>
                  </div>

                  <div class="col-md-6">
                    <label for="jarak_ke_sekolah_detail" class="form-label fw-semibold">Jarak Spesifik (Jika > 1 km)</label>
                    <input type="text" name="jarak_ke_sekolah_detail" id="jarak_ke_sekolah_detail" class="form-control" value="{{ old('jarak_ke_sekolah_detail') }}" placeholder="Contoh: 3.5 km">
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="waktu_tempuh" id="waktu_tempuh" class="form-select">
                      ...
                      <option value="kurang dari 30 menit" {{ old('waktu_tempuh') == 'kurang dari 30 menit' ? 'selected' : '' }}>Kurang dari 30 menit</option>
                      <option value="30 - 60 menit" {{ old('waktu_tempuh') == '30 - 60 menit' ? 'selected' : '' }}>30 - 60 menit</option>
                      <option value="lebih dari 60 menit" {{ old('waktu_tempuh') == 'lebih dari 60 menit' ? 'selected' : '' }}>Lebih dari 60 menit</option>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="card-body pt-3">
                    <div class="row g-3">
                      <div class="col-md-6">
                        ...
                        <input type="text" name="nama_ayah" id="nama_ayah" class="form-control" value="{{ old('nama_ayah') }}" placeholder="Nama ayah kandung">
                      </div>
                      <div class="col-md-3">
                        <label for="tempat_lahir_ayah" class="form-label fw-semibold">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir_ayah" id="tempat_lahir_ayah" class="form-control" value="{{ old('tempat_lahir_ayah') }}">
                      </div>
                      <div class="col-md-3">
                        <label for="tanggal_lahir_ayah" class="form-label fw-semibold">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir_ayah" id="tanggal_lahir_ayah" class="form-control" value="{{ old('tanggal_lahir_ayah') }}">
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="pekerjaan_ayah_id" id="pekerjaan_ayah_id" class="form-select">
                          ...
                          @foreach($daftarPekerjaan as $pek)
                            <option value="{{ $pek->id_pekerjaan }}" {{ old('pekerjaan_ayah_id') == $pek->id_pekerjaan ? 'selected' : '' }}>{{ $pek->nama_pekerjaan }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="pendidikan_ayah_id" id="pendidikan_ayah_id" class="form-select">
                          ...
                          @foreach($daftarPendidikan as $pen)
                            <option value="{{ $pen->id_pendidikan }}" {{ old('pendidikan_ayah_id') == $pen->id_pendidikan ? 'selected' : '' }}>{{ $pen->nama_pendidikan }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="agama_ayah_id" id="agama_ayah_id" class="form-select">
                          <option value="">-- Pilih Agama --</option>
                          @foreach($daftarAgama as $ag)
                            <option value="{{ $ag->id_agama }}" {{ old('agama_ayah_id') == $ag->id_agama ? 'selected' : '' }}>{{ $ag->nama_agama }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="penghasilan_ayah_id" id="penghasilan_ayah_id" class="form-select">
                          ...
                          @foreach($daftarPenghasilan as $peng)
                            <option value="{{ $peng->id_penghasilan }}" {{ old('penghasilan_ayah_id') == $peng->id_penghasilan ? 'selected' : '' }}>{{ $peng->label }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="card-body pt-3">
                    <div class="row g-3">
                      <div class="col-md-6">
                        ...
                        <input type="text" name="nama_ibu" id="nama_ibu" class="form-control" value="{{ old('nama_ibu') }}" placeholder="Nama ibu kandung">
                      </div>
                      <div class="col-md-3">
                        <label for="tempat_lahir_ibu" class="form-label fw-semibold">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir_ibu" id="tempat_lahir_ibu" class="form-control" value="{{ old('tempat_lahir_ibu') }}">
                      </div>
                      <div class="col-md-3">
                        <label for="tanggal_lahir_ibu" class="form-label fw-semibold">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir_ibu" id="tanggal_lahir_ibu" class="form-control" value="{{ old('tanggal_lahir_ibu') }}">
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="pekerjaan_ibu_id" id="pekerjaan_ibu_id" class="form-select">
                          <option value="">-- Pilih Pekerjaan --</option>
                          @foreach($daftarPekerjaan as $pek)
                            <option value="{{ $pek->id_pekerjaan }}" {{ old('pekerjaan_ibu_id') == $pek->id_pekerjaan ? 'selected' : '' }}>{{ $pek->nama_pekerjaan }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="pendidikan_ibu_id" id="pendidikan_ibu_id" class="form-select">
                          <option value="">-- Pilih Pendidikan --</option>
                          @foreach($daftarPendidikan as $pen)
                            <option value="{{ $pen->id_pendidikan }}" {{ old('pendidikan_ibu_id') == $pen->id_pendidikan ? 'selected' : '' }}>{{ $pen->nama_pendidikan }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="agama_ibu_id" id="agama_ibu_id" class="form-select">
                          <option value="">-- Pilih Agama --</option>
                          @foreach($daftarAgama as $ag)
                            <option value="{{ $ag->id_agama }}" {{ old('agama_ibu_id') == $ag->id_agama ? 'selected' : '' }}>{{ $ag->nama_agama }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="penghasilan_ibu_id" id="penghasilan_ibu_id" class="form-select">
                          <option value="">-- Pilih Penghasilan --</option>
                          @foreach($daftarPenghasilan as $peng)
                            <option value="{{ $peng->id_penghasilan }}" {{ old('penghasilan_ibu_id') == $peng->id_penghasilan ? 'selected' : '' }}>{{ $peng->label }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="card-body pt-3">
                    <div class="row g-3">
                      <div class="col-md-6">
                        ...
                        <input type="text" name="nama_wali" id="nama_wali" class="form-control" value="{{ old('nama_wali') }}" placeholder="Nama lengkap wali">
                      </div>
                      <div class="col-md-3">
                        <label for="tempat_lahir_wali" class="form-label fw-semibold">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir_wali" id="tempat_lahir_wali" class="form-control" value="{{ old('tempat_lahir_wali') }}">
                      </div>
                      <div class="col-md-3">
                        <label for="tanggal_lahir_wali" class="form-label fw-semibold">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir_wali" id="tanggal_lahir_wali" class="form-control" value="{{ old('tanggal_lahir_wali') }}">
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="pekerjaan_wali_id" id="pekerjaan_wali_id" class="form-select">
                          <option value="">-- Pilih Pekerjaan --</option>
                          @foreach($daftarPekerjaan as $pek)
                            <option value="{{ $pek->id_pekerjaan }}" {{ old('pekerjaan_wali_id') == $pek->id_pekerjaan ? 'selected' : '' }}>{{ $pek->nama_pekerjaan }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="pendidikan_wali_id" id="pendidikan_wali_id" class="form-select">
                          <option value="">-- Pilih Pendidikan --</option>
                          @foreach($daftarPendidikan as $pen)
                            <option value="{{ $pen->id_pendidikan }}" {{ old('pendidikan_wali_id') == $pen->id_pendidikan ? 'selected' : '' }}>{{ $pen->nama_pendidikan }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="agama_wali_id" id="agama_wali_id" class="form-select">
                          <option value="">-- Pilih Agama --</option>
                          @foreach($daftarAgama as $ag)
                            <option value="{{ $ag->id_agama }}" {{ old('agama_wali_id') == $ag->id_agama ? 'selected' : '' }}>{{ $ag->nama_agama }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-3">
                        ...
                        <select name="penghasilan_wali_id" id="penghasilan_wali_id" class="form-select">
                          <option value="">-- Pilih Penghasilan --</option>
                          @foreach($daftarPenghasilan as $peng)
                            <option value="{{ $peng->id_penghasilan }}" {{ old('penghasilan_wali_id') == $peng->id_penghasilan ? 'selected' : '' }}>{{ $peng->label }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
              ...
              <div class="tab-pane fade" id="tab-prestasi" role="tabpanel">
                ...
                <p class="text-muted small">
                  Jenis: 01. Sains, 02. Seni, 03. Olahraga, 04. Lain-lain | Tingkat: Sekolah, Kecamatan, Kab.Kota, Propinsi, Nasional, Internasional
                </p>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered dynamic-table align-middle" id="table-prestasi">
                    ...
                    <tbody>
                      ...
                      @endphp
                      @if(count($oldPrestasi) > 0)
                        @foreach($oldPrestasi as $index => $item)
                          <tr>
                            <td>
              ...
              <div class="tab-pane fade" id="tab-beasiswa" role="tabpanel">
                ...
                <p class="text-muted small">
                  Cantumkan riwayat beasiswa yang pernah diterima oleh calon peserta didik (jika ada).
                </p>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered dynamic-table align-middle" id="table-beasiswa">
                    ...
                    <tbody>
                      @php
                        $oldBeasiswa = old('beasiswa', []);
                      @endphp
                      @if(count($oldBeasiswa) > 0)
                        @foreach($oldBeasiswa as $index => $item)
                          <tr>
                            <td>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-success btn-lg px-4 shadow">
                      <i class="bi bi-check-circle-fill me-1"></i> Simpan Pendaftaran Siswa
                    </button>
                  </div>
                </div>
              </div>
