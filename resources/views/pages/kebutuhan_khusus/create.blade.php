    ...
    <div class="col-lg-8">
      ...
      <div class="card shadow-sm">
        <div class="card-body pt-3">
          <h5 class="card-title">Form Tambah Kebutuhan Khusus Baru</h5>

          <form action="{{ route('kebutuhan-khusus.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="kode" id="kode" class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode') }}" placeholder="Contoh: A, B, C, TIDAK, dll." required autofocus>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Contoh: Tunanetra (A), Tunarungu (B), Autis, Tidak Ada" required>
              </div>
              @error('nama')
                <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan') }}" placeholder="Catatan atau keterangan penjelasan">
              </div>
              @error('keterangan')
                <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
            ...
            <div class="mb-4">
              ...
              <div class="form-text">Jika aktif, pilihan ini akan dapat dipilih pada data siswa dan pendaftaran.</div>
            </div>
