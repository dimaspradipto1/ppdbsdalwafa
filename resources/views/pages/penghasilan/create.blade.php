...
@section('content')
<div class="pagetitle">
  <h1>Tambah Rentang Penghasilan</h1>
  <nav>
    <ol class="breadcrumb">
    ...
    <div class="col-lg-8">
      ...
      <div class="card shadow-sm">
        <div class="card-body pt-3">
          <h5 class="card-title">Form Tambah Rentang Penghasilan Baru</h5>
          ...
          <form action="{{ route('penghasilan.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="label" id="label" class="form-control @error('label') is-invalid @enderror" value="{{ old('label') }}" placeholder="Contoh: Rp 1.000.000 - Rp 1.999.999" required autofocus>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="number" step="any" name="batas_bawah" id="batas_bawah" class="form-control @error('batas_bawah') is-invalid @enderror" value="{{ old('batas_bawah') }}" placeholder="Contoh: 1000000">
                </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <span class="input-group-text">Rp</span>
                  <input type="number" step="any" name="batas_atas" id="batas_atas" class="form-control @error('batas_atas') is-invalid @enderror" value="{{ old('batas_atas') }}" placeholder="Contoh: 1999999">
                </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" name="urutan" id="urutan" class="form-control @error('urutan') is-invalid @enderror" value="{{ old('urutan', $nextUrutan) }}" placeholder="Contoh: 1, 2, 3">
              </div>
            ...
            <div class="mb-4">
              ...
              <div class="form-text">Jika aktif, pilihan ini akan muncul di formulir pendaftaran siswa.</div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="bi bi-save me-1"></i> Simpan Penghasilan
              </button>
            </div>
