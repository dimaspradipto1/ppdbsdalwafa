          ...
          <form action="{{ route('tahun-ajaran.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="tahun_ajaran" id="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror" value="{{ old('tahun_ajaran') }}" placeholder="Contoh: 2025/2026" required autofocus>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="nama_tahun_ajaran" id="nama_tahun_ajaran" class="form-control @error('nama_tahun_ajaran') is-invalid @enderror" value="{{ old('nama_tahun_ajaran') }}" placeholder="Contoh: Tahun Ajaran 2025/2026">
              </div>
            ...
            <div class="mb-4">
              ...
              <div class="input-group">
                ...
                <input type="text" name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan') }}" placeholder="Catatan tambahan seputar tahun ajaran ini">
              </div>
              @error('keterangan')
                <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
            ...
            <div class="d-flex justify-content-end gap-2">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="bi bi-save me-1"></i> Simpan Tahun Ajaran
              </button>
            </div>
