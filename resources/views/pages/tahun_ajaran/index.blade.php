...
@push('styles')
  ...
  <style>
    ...
    #tahun-ajaran-table .btn-sm:hover {
      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100" id="tahun-ajaran-table">
              <thead>
                <tr>
    ...
    $(document).ready(function () {
      const table = $('#tahun-ajaran-table').DataTable({
        ...
        language: {
          ...
          zeroRecords: "Tidak ada data tahun ajaran yang cocok",
      ...
      // SweetAlert2 Konfirmasi Hapus Tahun Ajaran
