...
@section('content')
<div class="pagetitle">
  <h1>Jalur Pendaftaran & Kuota</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item">Pengaturan & Master</li>
      <li class="breadcrumb-item active">Jalur & Kuota</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body pt-3">
          <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <div>
              <h5 class="card-title p-0 m-0">Daftar Jalur & Kuota Pendaftaran</h5>
              <p class="text-muted small mb-0">Atur kuota dan jalur penerimaan siswa (Reguler, Prestasi, Pindahan, dll)</p>
            </div>
            ...
            <div class="d-flex align-items-center gap-2">
              ...
              <a href="{{ route('jalur.create') }}" class="btn btn-primary btn-sm text-nowrap">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100" id="jalur-table">
              <thead>
                <tr>
                  <th style="width: 5%" class="text-center">No</th>
                  <th>Nama Jalur</th>
                  <th>Tahun Ajaran</th>
                  <th style="width: 15%" class="text-center">Kuota</th>
    ...
    $(document).ready(function () {
      const table = $('#jalur-table').DataTable({
        ...
        language: {
          ...
          zeroRecords: "Tidak ada jalur pendaftaran yang cocok",
