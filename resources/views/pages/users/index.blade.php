...
@section('content')
<div class="pagetitle">
  <h1>Manajemen Pengguna (Users)</h1>
  <nav>
    <ol class="breadcrumb">
      ...
      <div class="card">
        <div class="card-body pt-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="card-title p-0 m-0">Daftar Pengguna Sistem</h5>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100" id="users-table">
              <thead>
                <tr>
    ...
    $(document).ready(function () {
      const table = $('#users-table').DataTable({
        ...
        language: {
          ...
          infoEmpty: "Menampilkan 0 s/d 0 dari 0 pengguna",
