    ...
    <div class="col-lg-8">
      ...
      <div class="card shadow-sm">
        <div class="card-body pt-3">
          <h5 class="card-title">Form Tambah Agama Baru</h5>
          ...
          <form action="{{ route('agama.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="nama_agama" id="nama_agama" class="form-control @error('nama_agama') is-invalid @enderror" value="{{ old('nama_agama') }}" placeholder="Contoh: Islam, Kristen, Katolik, dll." required autofocus>
              </div>
              @error('nama_agama')
            ...
            <div class="mb-4">
              ...
              <div class="form-text">Jika aktif, opsi agama ini akan muncul pada formulir pendaftaran siswa.</div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="bi bi-save me-1"></i> Simpan Agama
              </button>
            </div>
