      ...
      <div class="card">
        <div class="card-body pt-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="card-title p-0 m-0">Daftar Data Agama</h5>
            <a href="{{ route('agama.create') }}" class="btn btn-primary btn-sm">
              <i class="bi bi-plus-lg me-1"></i> Tambah Agama
            </a>
          </div>

          <!-- Table with Yajra DataTables -->
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100" id="agama-table">
              <thead>
                <tr>
...
@push('scripts')
  ...
  <script>
    $(document).ready(function () {
      const table = $('#agama-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('agama.index') }}",
        columns: [
        ...
        language: {
          ...
          zeroRecords: "Tidak ada data agama yang cocok",
      ...
      // SweetAlert2 Konfirmasi Hapus Agama
      $(document).on('click', '.btn-delete', function () {
        ...
        Swal.fire({
          ...
          text: `Apakah Anda yakin ingin menghapus data agama "${name}"?`,
          icon: 'warning',
