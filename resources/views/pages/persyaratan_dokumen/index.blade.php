...
@section('content')
<div class="pagetitle">
  <h1>Persyaratan Dokumen Pendaftaran</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item">Pengaturan & Master</li>
      <li class="breadcrumb-item active">Persyaratan Dokumen</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body pt-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
              <h5 class="card-title p-0 m-0">Daftar Dokumen Persyaratan PPDB</h5>
              <p class="text-muted small mb-0">Aturan berkas yang wajib dilampirkan oleh calon siswa baru atau pindahan</p>
            </div>
            <a href="{{ route('persyaratan-dokumen.create') }}" class="btn btn-primary btn-sm">
            ...
            <table class="table table-striped table-hover align-middle w-100" id="dokumen-table">
              <thead>
                <tr>
                  ...
                  <th>Sasaran / Kategori</th>
                  <th>Jumlah Lembar</th>
                  <th style="width: 10%" class="text-center">Sifat</th>
    ...
    $(document).ready(function () {
      const table = $('#dokumen-table').DataTable({
        ...
        language: {
          ...
          zeroRecords: "Tidak ada persyaratan dokumen yang cocok",
