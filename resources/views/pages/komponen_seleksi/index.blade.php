...
@section('content')
<div class="pagetitle">
  <h1>Komponen & Kriteria Seleksi</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item">Pengaturan & Master</li>
      <li class="breadcrumb-item active">Komponen Seleksi</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body pt-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
              <h5 class="card-title p-0 m-0">Daftar Komponen & Kriteria Seleksi Masuk</h5>
              <p class="text-muted small mb-0">Atur kriteria penilaian, observasi kesiapan belajar, tes Al-Qur'an, dan wawancara</p>
            </div>
            <a href="{{ route('komponen-seleksi.create') }}" class="btn btn-primary btn-sm">
            ...
            <table class="table table-striped table-hover align-middle w-100" id="seleksi-table">
              <thead>
                <tr>
                  ...
                  <th>Nama Komponen Seleksi</th>
                  <th style="width: 12%" class="text-center">Nilai Min (KKM)</th>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#seleksi-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('komponen-seleksi.index') }}",
        columns: [
          { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false, className: 'text-center' },
          { data: 'nama_komponen', name: 'nama_komponen' },
          { data: 'nilai_minimal', name: 'nilai_minimal', className: 'text-center' },
          { data: 'bobot_persen', name: 'bobot_persen', className: 'text-center' },
        ...
        language: {
          ...
          zeroRecords: "Tidak ada komponen seleksi yang cocok",
