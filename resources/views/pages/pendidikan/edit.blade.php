          ...
          <form action="{{ route('pendidikan.update', $pendidikan->id_pendidikan) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="nama_pendidikan" id="nama_pendidikan" class="form-control @error('nama_pendidikan') is-invalid @enderror" value="{{ old('nama_pendidikan', $pendidikan->nama_pendidikan) }}" placeholder="Contoh: SD / Sederajat, SMA / SMK / Sederajat, S1, dll." required autofocus>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan', $pendidikan->keterangan) }}" placeholder="Keterangan atau catatan tambahan">
              </div>
              @error('keterangan')
                <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
            ...
            <div class="mb-4">
              ...
              <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1" {{ old('is_active', $pendidikan->is_active) ? 'checked' : '' }}>
                <label class="form-check-label" for="is_active">Aktifkan jenjang pendidikan ini</label>
              </div>
              <div class="form-text">Jika non-aktif, data ini tidak akan tampil dalam pilihan jenjang pendidikan.</div>
            </div>
