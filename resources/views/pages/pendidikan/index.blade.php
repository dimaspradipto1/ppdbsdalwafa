...
@section('content')
<div class="pagetitle">
  <h1>Master Data Jenjang Pendidikan</h1>
  <nav>
    <ol class="breadcrumb">
      ...
      <div class="card">
        <div class="card-body pt-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="card-title p-0 m-0">Daftar Jenjang Pendidikan</h5>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100" id="pendidikan-table">
              <thead>
                <tr>
...
@push('scripts')
  ...
  <script>
    $(document).ready(function () {
      const table = $('#pendidikan-table').DataTable({
        processing: true,
        serverSide: true,
        ...
        language: {
          ...
          zeroRecords: "Tidak ada data jenjang pendidikan yang cocok",
      ...
      // SweetAlert2 Konfirmasi Hapus Pendidikan
      $(document).on('click', '.btn-delete', function () {
        ...
        Swal.fire({
          ...
          text: `Apakah Anda yakin ingin menghapus data jenjang pendidikan "${name}"?`,
          icon: 'warning',
